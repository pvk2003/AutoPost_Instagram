...
Tool tự động **đăng bài Instagram** theo từng *service / lĩnh vực*.  
Kết hợp **Google Sheets + giao diện GUI (Tkinter)**.  
...
- ✅ GUI thân thiện – dễ dùng cho non-tech
...
├── caption_builder.py     # Build caption tự động
...
Chia sẻ cho email trong client_email của credentials.json
...
⚠️ Lưu ý quan trọng
URL KHÔNG được chứa #gid= hoặc gid=
...
Mở instagram.com và đăng nhập

Nhấn F12 → tab Application

Vào Cookies → instagram.com

Copy giá trị sessionid

Dán vào tab SESSIONID trong tool
...
Loại ký tự vô hình (Instagram rất ghét)
